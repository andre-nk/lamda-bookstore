...
const Hero = () => {
  return (
    <section className="dark:bg-gray-100 dark:text-gray-800">
      <div className="container my-24 flex flex-col items-center justify-center space-y-20 lg:my-[10vh] lg:flex-row lg:justify-between lg:space-x-[10%] lg:space-y-0">
        <div className="flex flex-col items-center justify-center rounded-sm text-center lg:w-[80%] lg:max-w-md lg:text-left xl:max-w-lg">
          <h1 className="font-serif text-3xl font-normal leading-5 md:text-4xl lg:text-[50px]">
